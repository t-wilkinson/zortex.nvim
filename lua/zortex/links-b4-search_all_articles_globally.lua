-- TODO: Local links like [/Heading] should work on files not in the main zortex directory. They should work on the current buffer.
-- TODO: [^1] footer notes like this should to a line like /[^1]: note or link/
-- TODO: sometimes links don't work. look for any potential logic errors or potential cracks.
