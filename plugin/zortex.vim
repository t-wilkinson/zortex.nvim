...
function! s:init_command() abort
    command! -nargs=* -bang ZortexSearch call zortex#article#search()
    command! -nargs=* -bang ZortexSearchUnique call zortex#article#search_unique()
    ...
    command! ZortexListitemToZettel call zortex#article#listitem_to_zettel()
