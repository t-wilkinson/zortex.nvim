...
syntax region zHeading1 matchgroup=zHeading start=/^\s*#\{1,2}\s/ end=/$/ contains=@zInline,zAttribute,zLink,zBright,zBold,zBrightBold,htmlItalic,htmlBold,htmlBoldItalic,mkdInlineURL,mkdLink,mkdURL,mkdID,zTag,@Spell keepend
syntax region zHeading2 matchgroup=zHeading start=/^\s*#\{3,4}\s/ end=/$/ contains=@zInline,zAttribute,zLink,zBright,zBold,zBrightBold,htmlItalic,htmlBold,htmlBoldItalic,mkdInlineURL,mkdLink,mkdURL,mkdID,zTag,@Spell keepend
syntax region zHeading3 matchgroup=zHeading start=/^\s*#\{5,6}\s/ end=/$/ contains=@zInline,zAttribute,zLink,zBright,zBold,zBrightBold,htmlItalic,htmlBold,htmlBoldItalic,mkdInlineURL,mkdLink,mkdURL,mkdID,zTag,@Spell keepend
...
hi zHeading1 gui=bold,italic guifg=#eb6f92
hi zHeading2 gui=bold,italic guifg=#ea9a97
hi zHeading3 gui=bold,italic guifg=#f6c177
